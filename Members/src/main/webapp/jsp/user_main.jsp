...
<body class="no-skin" style="background-color: white">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-4 center">
									...
									<div class="profile-user-info">
										...
										<div class="profile-info-row">
											<div class="profile-info-name">会员状态</div>
											<div class="profile-info-value">
										...
										<div class="profile-info-row">
											<div class="profile-info-name">推荐会员总数</div>
											<div class="profile-info-value">
												<span>${m.extendPro.myRecommed}</span>&nbsp;个
											</div>
										</div>
										<div class="profile-info-row">
											<div class="profile-info-name">账号余额</div>
											<div class="profile-info-value">
												<span>${m.mBalance}</span>元
											</div>
										</div>
									</div>
								</div>
	...
	<script type="text/javascript" src="jsp/js/user_main.js"></script>
</body>
</html>